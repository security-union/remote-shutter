...
public func !(actorRef: ActorRef, msg: Actor.Message) {
...
open class Actor: NSObject {
    ...
    final public func become(name: String, state : @escaping Receive) {
    ...
    final public func become(name: String, state : @escaping Receive, discardOld: Bool) {
    ...
    final public func systemReceive(msg: Actor.Message) {
        switch msg {
    ...
    open func receive(msg: Actor.Message) {
        switch msg {
        default :
    ...
    final public func tell(msg: Actor.Message) {
