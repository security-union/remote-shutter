...
public enum RemoteShutter_CommandAction: Int8, Enum, Verifiable {
  ...
  case setexposure = 33
  case setcinematic = 34
  case controlstatechanged = 35

  public static var max: RemoteShutter_CommandAction { return .controlstatechanged }
...
public enum RemoteShutter_ControlRefusal: Int8, Enum, Verifiable {
  ...
  case recording = 3
  case unsupported = 4
  case sessionrefused = 5

  public static var max: RemoteShutter_ControlRefusal { return .sessionrefused }
  public static var min: RemoteShutter_ControlRefusal { return .unknown }
}
...
public enum RemoteShutter_RecordingPhase: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  case unknown = 0
  ...
  public static var max: RemoteShutter_RecordingPhase { return .recording }
  public static var min: RemoteShutter_RecordingPhase { return .unknown }
}
...
public struct RemoteShutter_CommandParameters: FlatBufferObject, Verifiable {
  ...
  private enum VTOFFSET: VOffset {
    ...
    case exposureDurationSeconds = 68
    case exposureIso = 70
    case cinematicEnabled = 72
    case simulatedAperture = 74
  ...
  public var simulatedAperture: Float32 { let o = _accessor.offset(VTOFFSET.simulatedAperture.v); return o == 0 ? 0.0 : _accessor.readBuffer(of: Float32.self, at: o) }
  public static func startCommandParameters(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 36) }
  ...
  public static func add(simulatedAperture: Float32, _ fbb: inout FlatBufferBuilder) { fbb.add(element: simulatedAperture, def: 0.0, at: VTOFFSET.simulatedAperture.p) }
  ...
  public static func createCommandParameters(
    ...
    RemoteShutter_CommandParameters.add(simulatedAperture: simulatedAperture, &fbb)
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.simulatedAperture.p, fieldName: "simulatedAperture", required: false, type: Float32.self)
    _v.finish()
  }
}
...
public struct RemoteShutter_ExposureState: FlatBufferObject, Verifiable {
  ...
  private enum VTOFFSET: VOffset {
    case mode = 4
    case durationSeconds = 6
    case iso = 8
    case minDurationSeconds = 10
    case maxDurationSeconds = 12
    case minIso = 14
    case maxIso = 16
    var v: Int32 { Int32(self.rawValue) }
    var p: VOffset { self.rawValue }
  ...
  public static func startExposureState(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 7) }
...
public struct RemoteShutter_CinematicState: FlatBufferObject, Verifiable {
  ...
  private enum VTOFFSET: VOffset {
    case enabled = 4
    case simulatedAperture = 6
    case minSimulatedAperture = 8
    case maxSimulatedAperture = 10
    case defaultSimulatedAperture = 12
    case apertureLocked = 14
    case notEnoughLight = 16
    var v: Int32 { Int32(self.rawValue) }
    var p: VOffset { self.rawValue }
  }
  ...
  public var simulatedAperture: Float32 { let o = _accessor.offset(VTOFFSET.simulatedAperture.v); return o == 0 ? 0.0 : _accessor.readBuffer(of: Float32.self, at: o) }
  public var minSimulatedAperture: Float32 { let o = _accessor.offset(VTOFFSET.minSimulatedAperture.v); return o == 0 ? 0.0 : _accessor.readBuffer(of: Float32.self, at: o) }
  public var maxSimulatedAperture: Float32 { let o = _accessor.offset(VTOFFSET.maxSimulatedAperture.v); return o == 0 ? 0.0 : _accessor.readBuffer(of: Float32.self, at: o) }
  public var defaultSimulatedAperture: Float32 { let o = _accessor.offset(VTOFFSET.defaultSimulatedAperture.v); return o == 0 ? 0.0 : _accessor.readBuffer(of: Float32.self, at: o) }
  public var apertureLocked: Bool { let o = _accessor.offset(VTOFFSET.apertureLocked.v); return o == 0 ? false : _accessor.readBuffer(of: Bool.self, at: o) }
  public var notEnoughLight: Bool { let o = _accessor.offset(VTOFFSET.notEnoughLight.v); return o == 0 ? false : _accessor.readBuffer(of: Bool.self, at: o) }
  ...
  public static func add(simulatedAperture: Float32, _ fbb: inout FlatBufferBuilder) { fbb.add(element: simulatedAperture, def: 0.0, at: VTOFFSET.simulatedAperture.p) }
  public static func add(minSimulatedAperture: Float32, _ fbb: inout FlatBufferBuilder) { fbb.add(element: minSimulatedAperture, def: 0.0, at: VTOFFSET.minSimulatedAperture.p) }
  public static func add(maxSimulatedAperture: Float32, _ fbb: inout FlatBufferBuilder) { fbb.add(element: maxSimulatedAperture, def: 0.0, at: VTOFFSET.maxSimulatedAperture.p) }
  public static func add(defaultSimulatedAperture: Float32, _ fbb: inout FlatBufferBuilder) { fbb.add(element: defaultSimulatedAperture, def: 0.0, at: VTOFFSET.defaultSimulatedAperture.p) }
  public static func add(apertureLocked: Bool, _ fbb: inout FlatBufferBuilder) { fbb.add(element: apertureLocked, def: false,
   at: VTOFFSET.apertureLocked.p) }
  public static func add(notEnoughLight: Bool, _ fbb: inout FlatBufferBuilder) { fbb.add(element: notEnoughLight, def: false,
   at: VTOFFSET.notEnoughLight.p) }
  ...
  public static func createCinematicState(
    ...
    enabled: Bool = false,
    simulatedAperture: Float32 = 0.0,
    minSimulatedAperture: Float32 = 0.0,
    maxSimulatedAperture: Float32 = 0.0,
    defaultSimulatedAperture: Float32 = 0.0,
    apertureLocked: Bool = false,
    notEnoughLight: Bool = false
  ) -> Offset {
    let __start = RemoteShutter_CinematicState.startCinematicState(&fbb)
    RemoteShutter_CinematicState.add(enabled: enabled, &fbb)
    RemoteShutter_CinematicState.add(simulatedAperture: simulatedAperture, &fbb)
    RemoteShutter_CinematicState.add(minSimulatedAperture: minSimulatedAperture, &fbb)
    RemoteShutter_CinematicState.add(maxSimulatedAperture: maxSimulatedAperture, &fbb)
    RemoteShutter_CinematicState.add(defaultSimulatedAperture: defaultSimulatedAperture, &fbb)
    RemoteShutter_CinematicState.add(apertureLocked: apertureLocked, &fbb)
    RemoteShutter_CinematicState.add(notEnoughLight: notEnoughLight, &fbb)
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.simulatedAperture.p, fieldName: "simulatedAperture", required: false, type: Float32.self)
    try _v.visit(field: VTOFFSET.minSimulatedAperture.p, fieldName: "minSimulatedAperture", required: false, type: Float32.self)
    try _v.visit(field: VTOFFSET.maxSimulatedAperture.p, fieldName: "maxSimulatedAperture", required: false, type: Float32.self)
    try _v.visit(field: VTOFFSET.defaultSimulatedAperture.p, fieldName: "defaultSimulatedAperture", required: false, type: Float32.self)
    try _v.visit(field: VTOFFSET.apertureLocked.p, fieldName: "apertureLocked", required: false, type: Bool.self)
    try _v.visit(field: VTOFFSET.notEnoughLight.p, fieldName: "notEnoughLight", required: false, type: Bool.self)
    _v.finish()
  }
}

public struct RemoteShutter_ControlState: FlatBufferObject, Verifiable {
  ...
  public static var id: String { "RCAM" } 
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: RemoteShutter_ControlState.id, addPrefix: prefix) }
  private init(_ t: Table) { _accessor = t }
  public init(_ bb: ByteBuffer, o: Int32) { _accessor = Table(bb: bb, position: o) }
  ...
  private enum VTOFFSET: VOffset {
    case seq = 4
    case mode = 6
    case activeDeviceId = 8
    case currentLens = 10
    case availableLenses = 12
    case zoomFactor = 14
    case minZoom = 16
    case maxZoom = 18
    case zoomStops = 20
    case wideAngleZoomFactor = 22
    case supportsFocusPoint = 24
    case exposure = 26
    case cinematic = 28
    var v: Int32 { Int32(self.rawValue) }
    var p: VOffset { self.rawValue }
  ...
  public var seq: UInt64 { let o = _accessor.offset(VTOFFSET.seq.v); return o == 0 ? 0 : _accessor.readBuffer(of: UInt64.self, at: o) }
  ...
  public static func startControlState(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 13) }
  public static func add(seq: UInt64, _ fbb: inout FlatBufferBuilder) { fbb.add(element: seq, def: 0, at: VTOFFSET.seq.p) }
  ...
  public static func endControlState(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createControlState(
    _ fbb: inout FlatBufferBuilder,
    seq: UInt64 = 0,
    ...
    let __start = RemoteShutter_ControlState.startControlState(&fbb)
    RemoteShutter_ControlState.add(seq: seq, &fbb)
    RemoteShutter_ControlState.add(mode: mode, &fbb)
    RemoteShutter_ControlState.add(activeDeviceId: activeDeviceId, &fbb)
    RemoteShutter_ControlState.add(currentLens: currentLens, &fbb)
    RemoteShutter_ControlState.addVectorOf(availableLenses: availableLenses, &fbb)
    RemoteShutter_ControlState.add(zoomFactor: zoomFactor, &fbb)
    RemoteShutter_ControlState.add(minZoom: minZoom, &fbb)
    RemoteShutter_ControlState.add(maxZoom: maxZoom, &fbb)
    RemoteShutter_ControlState.addVectorOf(zoomStops: zoomStops, &fbb)
    RemoteShutter_ControlState.add(wideAngleZoomFactor: wideAngleZoomFactor, &fbb)
    RemoteShutter_ControlState.add(supportsFocusPoint: supportsFocusPoint, &fbb)
    RemoteShutter_ControlState.add(exposure: exposure, &fbb)
    RemoteShutter_ControlState.add(cinematic: cinematic, &fbb)
    return RemoteShutter_ControlState.endControlState(&fbb, start: __start)
  }

  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    var _v = try verifier.visitTable(at: position)
    try _v.visit(field: VTOFFSET.seq.p, fieldName: "seq", required: false, type: UInt64.self)
...
public struct RemoteShutter_CameraInfo: FlatBufferObject, Verifiable {
  ...
  private enum VTOFFSET: VOffset {
    ...
    case hasFlash = 6
    case hasTorch = 8
    case videoQuality = 10
    case photoQuality = 12
    var v: Int32 { Int32(self.rawValue) }
    var p: VOffset { self.rawValue }
  }
  ...
  public static func startCameraInfo(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 5) }
  public static func addVectorOf(availableLenses: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: availableLenses, at: VTOFFSET.availableLenses.p) }
...
public struct RemoteShutter_CameraCapabilities: FlatBufferObject, Verifiable {
  ...
  private enum VTOFFSET: VOffset {
    ...
    case supportsPreviewMode = 10
    case supportsMulticam = 12
    case control = 14
    var v: Int32 { Int32(self.rawValue) }
    var p: VOffset { self.rawValue }
  }
  ...
  public var control: RemoteShutter_ControlState? { let o = _accessor.offset(VTOFFSET.control.v); return o == 0 ? nil : RemoteShutter_ControlState(_accessor.bb, o: _accessor.indirect(o + _accessor.position)) }
  ...
  public static func createCameraCapabilities(
    ...
    RemoteShutter_CameraCapabilities.add(control: control, &fbb)
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.control.p, fieldName: "control", required: false, type: ForwardOffset<RemoteShutter_ControlState>.self)
    _v.finish()
  }
}
...
public struct RemoteShutter_CameraStateResponse: FlatBufferObject, Verifiable {
  ...
  private enum VTOFFSET: VOffset {
    ...
    case clockSyncEchoT0Ms = 18
    case clockSyncCameraClockMs = 20
    case captureIdEcho = 22
    case control = 24
    case controlRefusal = 26
    case controlRefusalDetail = 28
    var v: Int32 { Int32(self.rawValue) }
    var p: VOffset { self.rawValue }
  }
  ...
  public var control: RemoteShutter_ControlState? { let o = _accessor.offset(VTOFFSET.control.v); return o == 0 ? nil : RemoteShutter_ControlState(_accessor.bb, o: _accessor.indirect(o + _accessor.position)) }
  public var controlRefusal: RemoteShutter_ControlRefusal { let o = _accessor.offset(VTOFFSET.controlRefusal.v); return o == 0 ? .unknown : RemoteShutter_ControlRefusal(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .unknown }
  public var controlRefusalDetail: String? { let o = _accessor.offset(VTOFFSET.controlRefusalDetail.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var controlRefusalDetailSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.controlRefusalDetail.v) }
  ...
  public static func add(control: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: control, at: VTOFFSET.control.p) }
  public static func add(controlRefusal: RemoteShutter_ControlRefusal, _ fbb: inout FlatBufferBuilder) { fbb.add(element: controlRefusal.rawValue, def: 0, at: VTOFFSET.controlRefusal.p) }
  public static func add(controlRefusalDetail: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: controlRefusalDetail, at: VTOFFSET.controlRefusalDetail.p) }
  ...
  public static func createCameraStateResponse(
    ...
    controlOffset control: Offset = Offset(),
    controlRefusal: RemoteShutter_ControlRefusal = .unknown,
    controlRefusalDetailOffset controlRefusalDetail: Offset = Offset()
  ) -> Offset {
    ...
    RemoteShutter_CameraStateResponse.add(control: control, &fbb)
    RemoteShutter_CameraStateResponse.add(controlRefusal: controlRefusal, &fbb)
    RemoteShutter_CameraStateResponse.add(controlRefusalDetail: controlRefusalDetail, &fbb)
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.control.p, fieldName: "control", required: false, type: ForwardOffset<RemoteShutter_ControlState>.self)
    try _v.visit(field: VTOFFSET.controlRefusal.p, fieldName: "controlRefusal", required: false, type: RemoteShutter_ControlRefusal.self)
    try _v.visit(field: VTOFFSET.controlRefusalDetail.p, fieldName: "controlRefusalDetail", required: false, type: ForwardOffset<String>.self)
    _v.finish()
  }
}
