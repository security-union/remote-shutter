...
public class FlatBuffersSetupTest {
    ...
    private static func testBuilderCreation() {
        ...
        print("   ✓ FlatBufferBuilder created with capacity: \(builder.capacity)")
    ...
    private static func testBasicSerialization() {
        ...
        let idString = builder.create(string: "test-command-123")
        ...
        let data = Data(builder.sizedBuffer)
        print("   ✓ Serialized data size: \(data.count) bytes")
        
        // Test deserialization
        let buffer = ByteBuffer(data: data)
        let command = RemoteShutter_CameraCommand.getRootAs(bb: buffer)
    ...
    public static func runPerformanceTest() {
        ...
        for i in 0..<iterations {
            let builder = FlatBufferBuilder(initialSize: 512)
            ...
            builder.finish(offset: commandOffset)
            let _ = Data(builder.sizedBuffer)
        }
