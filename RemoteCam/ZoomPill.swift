...
/// Camera-style detented zoom and lens control for the director screen.
///
...
/// with the exposure rulers); all zoom math is `ZoomScale`'s, which the pinch gesture shares.
